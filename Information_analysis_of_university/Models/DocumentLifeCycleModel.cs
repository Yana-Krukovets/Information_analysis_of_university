...
{
    //класс модели жизненного цикла документа
    ...
    //класс жизненного цикла документа
    public class LifeCycle
    {
        ...
        //document - документ, для которого формируется ЖЦ
        //usingDocuments - список документов, для которых уже построены жизненные циклы
        public LifeCycle(Document document, ref List<Document> usingDocuments)
        {
            //формирование жизненного цикла
        ...
        //функция посиска этапов жизненного цикла
        private void NextPost(Document document, ref List<Document> documentList)
        {
            ...
            //нахоим ответственного за выполнение
